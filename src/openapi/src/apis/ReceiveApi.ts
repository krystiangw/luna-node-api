...
import {
    CreateFundingAddressResponseFromJSON,
    CreateFundingAddressResponseToJSON,
    GetFundingAddressResponseFromJSON,
    GetFundingAddressResponseToJSON,
} from '../models';
 ...
 * 
 */
export class ReceiveApi extends runtime.BaseAPI implements ReceiveApiInterface {

    /**
     * Allocates a new receive address to your account. There is a rate limit of 1 address per hour, but bursts of up to 10 addresses are allowed. Only 1 Ethereum receive address can be created.  Permissions required: <code>Perm_W_Addresses</code>
     * # Create receive address
     */
    async createFundingAddressRaw(requestParameters: CreateFundingAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateFundingAddressResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CreateFundingAddressResponseFromJSON(jsonValue));
    }
     ...
     * # Create receive address
     */
    async createFundingAddress(requestParameters: CreateFundingAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateFundingAddressResponse> {
     ...
     * # Get receive address
     */
    async getFundingAddressRaw(requestParameters: GetFundingAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetFundingAddressResponse>> {
        if (requestParameters.asset === null || requestParameters.asset === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetFundingAddressResponseFromJSON(jsonValue));
    }
     ...
     * # Get receive address
     */
    async getFundingAddress(requestParameters: GetFundingAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetFundingAddressResponse> {
