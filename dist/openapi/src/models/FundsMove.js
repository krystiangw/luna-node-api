...
exports.FundsMoveToJSON = exports.FundsMoveFromJSONTyped = exports.FundsMoveFromJSON = exports.instanceOfFundsMove = exports.FundsMoveStatusEnum = void 0;
const runtime_1 = require("../runtime");
/**
 * @export
 */
exports.FundsMoveStatusEnum = {
    Created: 'CREATED',
    Moving: 'MOVING',
 ...
 */
function instanceOfFundsMove(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfFundsMove = instanceOfFundsMove;
function FundsMoveFromJSON(json) {
    return FundsMoveFromJSONTyped(json, false);
}
exports.FundsMoveFromJSON = FundsMoveFromJSON;
function FundsMoveFromJSONTyped(json, ignoreDiscriminator) {
...
exports.FundsMoveFromJSONTyped = FundsMoveFromJSONTyped;
function FundsMoveToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.FundsMoveToJSON = FundsMoveToJSON;
//# sourceMappingURL=FundsMove.js.map