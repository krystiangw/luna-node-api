...
exports.CreateFundingAddressResponseToJSON = exports.CreateFundingAddressResponseFromJSONTyped = exports.CreateFundingAddressResponseFromJSON = exports.instanceOfCreateFundingAddressResponse = void 0;
 ...
 */
function instanceOfCreateFundingAddressResponse(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCreateFundingAddressResponse = instanceOfCreateFundingAddressResponse;
function CreateFundingAddressResponseFromJSON(json) {
    return CreateFundingAddressResponseFromJSONTyped(json, false);
}
exports.CreateFundingAddressResponseFromJSON = CreateFundingAddressResponseFromJSON;
function CreateFundingAddressResponseFromJSONTyped(json, ignoreDiscriminator) {
...
exports.CreateFundingAddressResponseFromJSONTyped = CreateFundingAddressResponseFromJSONTyped;
function CreateFundingAddressResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CreateFundingAddressResponseToJSON = CreateFundingAddressResponseToJSON;
//# sourceMappingURL=CreateFundingAddressResponse.js.map