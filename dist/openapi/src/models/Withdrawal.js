...
exports.WithdrawalToJSON = exports.WithdrawalFromJSONTyped = exports.WithdrawalFromJSON = exports.instanceOfWithdrawal = exports.WithdrawalStatusEnum = void 0;
 ...
 */
function instanceOfWithdrawal(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfWithdrawal = instanceOfWithdrawal;
function WithdrawalFromJSON(json) {
    return WithdrawalFromJSONTyped(json, false);
}
exports.WithdrawalFromJSON = WithdrawalFromJSON;
function WithdrawalFromJSONTyped(json, ignoreDiscriminator) {
...
exports.WithdrawalFromJSONTyped = WithdrawalFromJSONTyped;
function WithdrawalToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
