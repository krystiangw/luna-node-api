...
exports.ReceiveAddressToJSON = exports.ReceiveAddressFromJSONTyped = exports.ReceiveAddressFromJSON = exports.instanceOfReceiveAddress = void 0;
const runtime_1 = require("../runtime");
const AddressMeta_1 = require("./AddressMeta");
/**
 * Check if a given object implements the ReceiveAddress interface.
 */
function instanceOfReceiveAddress(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReceiveAddress = instanceOfReceiveAddress;
function ReceiveAddressFromJSON(json) {
    return ReceiveAddressFromJSONTyped(json, false);
}
exports.ReceiveAddressFromJSON = ReceiveAddressFromJSON;
function ReceiveAddressFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ReceiveAddressFromJSONTyped = ReceiveAddressFromJSONTyped;
function ReceiveAddressToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ReceiveAddressToJSON = ReceiveAddressToJSON;
//# sourceMappingURL=ReceiveAddress.js.map