...
import type { CancelWithdrawalResponse, CreateWithdrawalResponse, GetWithdrawalResponse, ListTransfersResponse, ListWithdrawalsResponse } from '../models';
 ...
 *
 */
export declare class TransfersApi extends runtime.BaseAPI implements TransfersApiInterface {
    /**
     * Cancels a withdrawal request. This can only be done if the request is still in state <code>PENDING</code>.  Permissions required: <code>Perm_W_Withdrawals</code>
     * Cancel withdrawal request
     */
...
//# sourceMappingURL=TransfersApi.d.ts.map